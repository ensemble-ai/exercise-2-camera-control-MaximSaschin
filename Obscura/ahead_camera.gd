...
@export var lead_speed: float = 8.0 # How fast the camera moves ahead of the vessel
@export var leash_distance: float = 20.0 # How far the camera can be ahead of the vessel
...
func _process(delta: float) -> void:
	...
	# If the vessel is moving, adjust the camera position to lead ahead of the vessel
